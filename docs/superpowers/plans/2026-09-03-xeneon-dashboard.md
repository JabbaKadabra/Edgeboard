...
**Goal:** Build `edgeboard`, a localhost web dashboard for a 2560×720 Corsair Xeneon Edge showing Claude usage, Claude Code sessions, Spotify, and system metrics.
...
**Files:**
- Create: `pyproject.toml`, `edgeboard/__init__.py`, `edgeboard/__main__.py`, `edgeboard/config.py`, `tests/test_config.py`, `.gitignore`
...
- [ ] Test: `from_env({})` gives defaults (`~/.claude`, 127.0.0.1, 8765, "spotify"); `from_env({"EDGEBOARD_PORT":"9000","EDGEBOARD_CLAUDE_DIR":"/x"})` overrides.
- [ ] Implement `config.py`; `__main__` calls `edgeboard.server.main()`.
- [ ] `pytest -q` green. Commit `feat: scaffold edgeboard package`.

### Task 2: Transcript parsing

**Files:**
- Create: `edgeboard/collectors/__init__.py`, `edgeboard/collectors/claude_transcripts.py`, `tests/test_transcripts.py`, `tests/fixtures.py` (helpers building JSONL lines).
...
**Files:**
- Create: `edgeboard/collectors/claude_sessions.py`, `tests/test_sessions.py`
...
**Files:**
- Create: `edgeboard/collectors/claude_usage.py`, `tests/test_usage.py`
...
**Files:**
- Create: `edgeboard/collectors/spotify.py`, `tests/test_spotify.py`
...
**Files:**
- Create: `edgeboard/collectors/system.py`, `tests/test_system.py`
...
**Files:**
- Create: `edgeboard/state.py`, `edgeboard/server.py`, `tests/test_server.py`
...
**Files:**
- Create: `edgeboard/static/index.html`, `edgeboard/static/style.css`, `edgeboard/static/app.js`
...
- [ ] Manual check with a fake-state mode: `EDGEBOARD_DEMO=1` makes the server serve a canned snapshot so the page can be previewed anywhere (implemented in `edgeboard/demo.py`).
